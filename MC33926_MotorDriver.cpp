...
#include "MC33926_MotorDriver.h"

/**
 * @brief Constructor for MC33926_MotorDriver controller
 ...
 */
MC33926_MotorDriver::MC33926_MotorDriver(uint32_t pin_EN, uint32_t pin_PWM1, uint32_t pin_PWM2, uint32_t pin_FB, float Vin, float deadzone) {
    this->pin_EN = pin_EN;
 ...
 */
void MC33926_MotorDriver::setVoltage(float voltage) {
 ...
 */
void MC33926_MotorDriver::enable() {
 ...
 */
void MC33926_MotorDriver::disable() {
 ...
 */
float MC33926_MotorDriver::readCurrent() {
 ...
 */
float MC33926_MotorDriver::getLastVoltage() {
    return lastVoltage;
}